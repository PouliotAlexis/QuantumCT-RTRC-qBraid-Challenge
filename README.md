...
├── data/
│   ├── Instance[N].txt            # Solution files generated by latest run
│   ├── run_results.csv            # Quantum resource metrics history
│   └── optimal_results.csv        # Known optimal/heuristic solutions
├── final_data/                    # Curated results per instance (images, CSVs, txt)
